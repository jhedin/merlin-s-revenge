property pFrameRate, pFrameLength, pLastTime, pOutput, pOutputOn, pTimeSample, pTimeSampleLength, pMaxTime, pMaxTimeCount
global g
...
on getAverageFrameTime me
  numSamples = pTimeSample.count
  total = 0
  repeat with sample in pTimeSample
    total = total + sample
  end repeat
