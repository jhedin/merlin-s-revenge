property ancestor, pAllowRangeSelections, pAllTilesImage, pCopyPixelsParams, pDisplayScale, pDisplayTileMap, pGridSelector, pTiles, pTileSize, pSizeInTiles, pSprites
global g
...
on setDisplayScale me, theScale
  pDisplayScale = theScale
end
